...
import { AlertTriangle, CheckCircle2, Hammer, LayoutDashboard, Wrench } from "lucide-react";
...
export default function Dashboard({ stats }: Props) {
	const cards: StatCard[] = [
		...
		},
		{
			...
			href: incidents({ query: { status: "in_progress" } }),
			icon: Hammer,
		...
		},
		{
			...
			href: incidents({ query: { status: "open" } }),
			icon: AlertTriangle,
			accent: "text-red-400",
		},
		{
			...
			href: incidents({ query: { status: "resolved" } }),
			icon: CheckCircle2,
